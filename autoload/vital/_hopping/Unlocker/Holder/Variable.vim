...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_hopping#Unlocker#Holder#Variable#import() abort
  ...
  execute join(['function! vital#_hopping#Unlocker#Holder#Variable#import() abort', printf("return map({'is_makeable': '', 'make': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
