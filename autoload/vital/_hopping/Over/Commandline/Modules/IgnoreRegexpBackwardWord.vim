...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_hopping#Over#Commandline#Modules#IgnoreRegexpBackwardWord#import() abort
  ...
  execute join(['function! vital#_hopping#Over#Commandline#Modules#IgnoreRegexpBackwardWord#import() abort', printf("return map({'backward_word': '', 'make': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
