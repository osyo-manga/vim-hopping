...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_hopping#Over#Exception#import() abort
  ...
  execute join(['function! vital#_hopping#Over#Exception#import() abort', printf("return map({'throw': '', 'throw_cmd': '', 'set_prefix': '', 'error': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
