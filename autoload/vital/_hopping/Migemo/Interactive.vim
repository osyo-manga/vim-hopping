...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_hopping#Migemo#Interactive#import() abort
    return map({'make_process': '', '_vital_depends': '', 'generate_regexp': '', 'log': '', '_vital_loaded': ''},  'function("s:" . v:key)')
  endfunction
else
  function! s:_SID() abort
    return matchstr(expand('<sfile>'), '<SNR>\zs\d\+\ze__SID$')
  endfunction
  execute join(['function! vital#_hopping#Migemo#Interactive#import() abort', printf("return map({'make_process': '', '_vital_depends': '', 'generate_regexp': '', 'log': '', '_vital_loaded': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
