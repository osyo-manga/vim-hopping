...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_hopping#Coaster#Window#import() abort
  ...
  execute join(['function! vital#_hopping#Coaster#Window#import() abort', printf("return map({'as_windo': '', '_vital_depends': '', 'windo': '', '_vital_loaded': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
