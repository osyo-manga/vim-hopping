...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_hopping#Palette#Highlight#import() abort
  ...
  execute join(['function! vital#_hopping#Palette#Highlight#import() abort', printf("return map({'capture': '', '_vital_depends': '', 'parse': '', 'group_list': '', 'set': '', 'parse_to_name': '', 'links_to': '', 'get': '', '_vital_loaded': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
