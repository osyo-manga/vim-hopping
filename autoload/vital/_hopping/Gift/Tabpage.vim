...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_hopping#Gift#Tabpage#import() abort
  ...
  execute join(['function! vital#_hopping#Gift#Tabpage#import() abort', printf("return map({'uniq_nr': '', 'make_uniq_nr': '', 'numbering': '', 'set_prefix': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
